                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12 col-12 col-sm-12">
                            ...
                            <h2 className="font-weight-bold py-4 text-purple d-none d-sm-block">
                                <span className="text-pink">FoodMarket </span>
                                is here to 
                            ...
                            <div className="form-group row">
                                <div className="col-lg-6 col-md-6 col-sm-12 col-12 menu-phone">
                                    ...
                                    <div className="input-group mt-4">
                                        <SearchForm type="text" className="form-control text-purple" placeholder="What are you craving for?" onChange={(e) => setSearch(e.target.value)}/>
